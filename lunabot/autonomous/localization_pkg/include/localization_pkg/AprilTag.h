...
public:
    ...
    void detectTag() {
        ...
        cv::Mat cameraMatrix = (cv::Mat1d(3, 3)
                << 278.5971299187092, 0, 323.0268692272516, 0, 284.902753361877, 235.7951612448387, 0, 0, 1);
        cv::Mat distortionCoefficients = (cv::Mat1d(1, 5)
                << -0.08455656319490816, 0.09495737180245305, 0.005608739170439007, -0.007920839212581778, -0.05865648378565153);
