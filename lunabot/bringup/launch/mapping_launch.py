...
def launch_setup(context, *args, **kwargs):
    ...
    return [
        ...
        DeclareLaunchArgument(
            ...
            default_value=ConditionalText(
                "".join(
                    [LaunchConfiguration("depth_topic").perform(context), "_relay"]
                ),
        ...
        DeclareLaunchArgument(
            ...
            default_value=ConditionalText(
                "".join(
                    [LaunchConfiguration("left_image_topic").perform(context), "_relay"]
                ),
        ...
        DeclareLaunchArgument(
            ...
            default_value=ConditionalText(
                "".join(
                    [
                        LaunchConfiguration("right_image_topic").perform(context),
                        "_relay",
                    ]
                ),
        ...
        DeclareLaunchArgument(
            ...
            default_value=ConditionalText(
                ...
                "".join([LaunchConfiguration("rgbd_topic").perform(context), "_relay"]),
            ...
            condition=IfCondition(
                PythonExpression(
                    [
                        ...
                        "'=='true') and '",
                        LaunchConfiguration("compressed"),
                        "' == 'true'",
                    ]
                )
            ),
        ...
        Node(
            ...
            parameters=[{"qos": LaunchConfiguration("qos_image")}],
            remappings=[
        ...
        Node(
            ...
            parameters=[{"uncompress": True, "qos": LaunchConfiguration("qos_image")}],
            remappings=[
            ...
            parameters=[
                {
                    ...
                    "ground_truth_frame_id": LaunchConfiguration(
                        "ground_truth_frame_id"
                    ).perform(context),
                    "ground_truth_base_frame_id": LaunchConfiguration(
                    ...
                    "guess_frame_id": LaunchConfiguration(
                        "odom_guess_frame_id"
                    ).perform(context),
                    "guess_min_translation": LaunchConfiguration(
                        "odom_guess_min_translation"
                    ),
                    "guess_min_rotation": LaunchConfiguration(
            ...
            parameters=[
                {
                    ...
                    "odom_tf_angular_variance": LaunchConfiguration(
                        "odom_tf_angular_variance"
                    ),
                    "odom_tf_linear_variance": LaunchConfiguration(
                    ...
                    "landmark_angular_variance": LaunchConfiguration(
                        "tag_angular_variance"
                    ),
                    "Mem/IncrementalMemory": ConditionalText(
                        "true",
                        "false",
                        IfCondition(
                            PythonExpression(
                    ...
                    "Mem/InitWMWithAllNodes": ConditionalText(
                        "true",
                        "false",
                        IfCondition(
                            PythonExpression(
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "rviz", default_value="false", description="Launch RVIZ (optional)."
            ),
            DeclareLaunchArgument(
                "use_sim_time",
                default_value="false",
            ...
            DeclareLaunchArgument(
                "wait_for_transform", default_value="0.2", description=""
            ),
            DeclareLaunchArgument(
                "rtabmap_args",
            ...
            DeclareLaunchArgument(
                "ground_truth_frame_id", default_value="", description='e.g., "world"'
            ),
            DeclareLaunchArgument(
                "ground_truth_base_frame_id",
                default_value="",
            ...
            DeclareLaunchArgument(
                "depth_topic",
                default_value="/d455/depth/image_rect_raw",
                description="",
            ),
            DeclareLaunchArgument(
                "camera_info_topic",
                default_value="/d455/depth/camera_info",
                description="",
            ),
            # Stereo related topics
            DeclareLaunchArgument(
                "stereo_namespace", default_value="/stereo_camera", description=""
            ),
            DeclareLaunchArgument(
                "left_image_topic",
                default_value=[
                    LaunchConfiguration("stereo_namespace"),
            ...
            DeclareLaunchArgument(
                "rgbd_topic", default_value="rgbd_image", description=""
            ),
            ...
            DeclareLaunchArgument(
                "scan_cloud_topic", default_value="/scan_cloud", description=""
            ),
            ...
            DeclareLaunchArgument(
                "publish_tf_odom", default_value="false", description=""
            ),
            DeclareLaunchArgument(
                "odom_tf_angular_variance",
                default_value="0.01",
            ...
            DeclareLaunchArgument(
                "odom_guess_min_rotation", default_value="0.0", description=""
            ),
            # imu
            DeclareLaunchArgument(
                "imu_topic",
            ...
            DeclareLaunchArgument(
                "wait_imu_to_init", default_value="false", description=""
            ),
            # User Data
            DeclareLaunchArgument(
                "subscribe_user_data",
            ...
            DeclareLaunchArgument(
                "user_data_topic", default_value="/user_data", description=""
            ),
            DeclareLaunchArgument(
            ...
            DeclareLaunchArgument(
                "tag_linear_variance", default_value="0.0001", description=""
            ),
            DeclareLaunchArgument(
                "tag_angular_variance",
