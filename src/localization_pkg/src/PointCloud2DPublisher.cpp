...
private:
    ...
    void pointCloudCallback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
        ...
        laser_scan_msg.time_increment = 0.0;  // Time between measurements (if your sensor provides this information)
        laser_scan_msg.scan_time = 0.1;       // Time it takes to complete one scan (if your sensor provides this information)
